...
async function seed() {
    ...
    const docData = [
        { name: 'Dr. Ahmed Raza',      charges: 2500, category: 'Physiotherapist',        rating: 4.8, availability: 'Available',     image: p(0), experience: 8,  qualification: 'DPT, MSPT (UK)',                         description: 'Specialist in musculoskeletal physiotherapy with expertise in post-surgical rehabilitation and sports injuries.' },
        { name: 'Dr. Sana Tariq',      charges: 2000, category: 'Physiotherapist',        rating: 4.6, availability: 'Available',     image: p(1), experience: 5,  qualification: 'DPT, Certified Manual Therapist',        description: 'Expert in neurological physiotherapy and pediatric rehabilitation with evidence-based treatment protocols.' },
        { name: 'Dr. Fatima Khan',     charges: 3500, category: 'Psychologist',           rating: 4.9, availability: 'Limited Slots', image: p(2), experience: 10, qualification: 'PhD Clinical Psychology (UK)',            description: 'Specialist in CBT and trauma-focused therapy. Expert in anxiety, depression, and PTSD treatment.' },
        { name: 'Dr. Hassan Javed',    charges: 5500, category: 'Neurologist',            rating: 4.8, availability: 'Available',     image: p(3), experience: 13, qualification: 'MBBS, FCPS Neurology',                    description: 'Expert in epilepsy management and headache disorders. Specialist in EEG interpretation.' },
        { name: 'Dr. Ayesha Siddiqui', charges: 6000, category: 'Neurologist',            rating: 4.9, availability: 'Limited Slots', image: p(4), experience: 16, qualification: 'MBBS, FCPS Neurology, Fellowship (USA)',  description: 'Leading neurologist specializing in stroke rehabilitation and Parkinson disease management.' },
        { name: 'Dr. Talha Qureshi',   charges: 3000, category: 'Physiotherapist',        rating: 4.9, availability: 'Limited Slots', image: p(5), experience: 12, qualification: 'DPT, PhD Rehabilitation Sciences',       description: 'Senior physiotherapist with expertise in spinal rehabilitation and chronic pain management.' },
        { name: 'Dr. Lubna Farooq',    charges: 2200, category: 'Physiotherapist',        rating: 4.7, availability: 'Available',     image: p(0), experience: 6,  qualification: 'DPT, MSc Sports Medicine',                description: 'Specializes in post-partum rehabilitation. Certified in dry needling and manual therapy.' },
        ...
        { name: 'Dr. Muhammad Saleem', charges: 5000, category: 'Orthopedic Specialist',  rating: 4.9, availability: 'Limited Slots', image: p(3), experience: 18, qualification: 'MBBS, FCPS Orthopedics',                  description: 'Senior orthopedic surgeon with expertise in joint replacement and spinal surgery.' },
        { name: 'Dr. Nadia Malik',     charges: 4500, category: 'Orthopedic Specialist',  rating: 4.7, availability: 'Available',     image: p(4), experience: 12, qualification: 'MBBS, FCPS Orthopedics, Fellowship (Germany)', description: 'Pioneer in pediatric orthopedics and minimally invasive spinal procedures.' },
        ...
        { name: 'Dr. Bilal Mahmood',   charges: 2500, category: 'Occupational Therapist', rating: 4.7, availability: 'Available',     image: p(1), experience: 7,  qualification: 'B.Sc OT, MSc Rehabilitation (UK)',        description: 'Expert in sensory integration therapy and hand rehabilitation for post-stroke patients.' },
        ...
        { name: 'Dr. Saad Mirza',      charges: 3000, category: 'Occupational Therapist', rating: 4.8, availability: 'Limited Slots', image: p(3), experience: 10, qualification: 'B.Sc OT, MSc Neurorehabilitation',       description: 'Expert in neurological OT for TBI, stroke and spinal cord injury patients.' },
        { name: 'Dr. Zara Hussain',    charges: 2500, category: 'Speech Therapist',       rating: 4.8, availability: 'Available',     image: p(4), experience: 8,  qualification: 'M.Sc Speech Language Pathology (USA)',    description: 'Expert in articulation disorders, stuttering therapy and voice rehabilitation.' },
        { name: 'Dr. Rizwan Haider',   charges: 3200, category: 'Speech Therapist',       rating: 4.9, availability: 'Available',     image: p(5), experience: 12, qualification: 'PhD Communication Disorders (Australia)',  description: 'Senior speech pathologist. Expert in voice disorders and post-stroke communication recovery.' },
        { name: 'Dr. Usman Ali',       charges: 4500, category: 'Rehabilitation Consultant', rating: 4.8, availability: 'Available', image: p(0), experience: 14, qualification: 'MBBS, FCPS Rehabilitation Medicine',      description: 'Specialist in comprehensive rehabilitation for post-stroke and spinal cord injury patients.' },
